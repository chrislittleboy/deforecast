...
RcppExport SEXP _deforecasteR_probseed(SEXP agesSEXP, SEXP agebandsSEXP, SEXP probbandsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type ages(agesSEXP);
    Rcpp::traits::input_parameter< const NumericVector >::type agebands(agebandsSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type probbands(probbandsSEXP);
    rcpp_result_gen = Rcpp::wrap(probseed(ages, agebands, probbands));
    return rcpp_result_gen;
END_RCPP
}
// seedsample
NumericVector seedsample(NumericVector pr);
RcppExport SEXP _deforecasteR_seedsample(SEXP prSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type pr(prSEXP);
    rcpp_result_gen = Rcpp::wrap(seedsample(pr));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_deforecasteR_probseed", (DL_FUNC) &_deforecasteR_probseed, 3},
    {"_deforecasteR_seedsample", (DL_FUNC) &_deforecasteR_seedsample, 1},
    {NULL, NULL, 0}
};
